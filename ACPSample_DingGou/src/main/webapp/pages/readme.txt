...
3) 测试界面中的交易时一定要先配置好私钥签名证书，验签公钥证书。
                                                   ...
                                                   全渠道代收产品消费交易示例地址为：http://IP：端口/ACPSample_DingGou
───────────
...
ACPSample_DingGou
  ...
  │  │  │
  │  │  ├Form_6_2_RealAuth_Back.java┈┈┈┈┈后台实名认证示例类（后台）
  │  │  │
  │  │  ├Form_6_2_RealAuth_Front.java┈┈┈┈┈前台实名认证示例类（前台）
  │  │  │
  │  │  ├Form_6_3_Consume.java┈┈┈┈┈消费示例类（后台）
  │  │  │
  │  │  ├Form_6_4_ConsumeUndo.java┈┈┈┈┈消费撤销示例类 （后台）
  │  │  │
  │  │  ├Form_6_5_Refund.java┈┈┈┈┈退货示例类 （后台）
  │  │  │
  │  │  ├Form_6_6_Query.java┈┈┈┈┈交易状态查询示例类 （后台）
  │  │  │
  │  │  ├Form_6_7_1_AuthDeal.java┈┈┈┈┈预授权示例类 （后台）
  │  │  │
  │  │  ├Form_6_7_2_AuthUndo.java┈┈┈┈┈预授权撤销示例类 （后台）
  │  │  │
  │  │  ├Form_6_7_3_AuthFinish.java┈┈┈┈┈预授权完成示例类 （后台）
  │  │  │
  │  │  ├Form_6_7_4_AuthFinishUndo.java┈┈┈┈┈预授权完成撤销示例类 （后台）
  │  │  │
  │  │  ├Form09_7_FileTransfer.java┈┈┈┈┈对账文件下载示例（后台）        
  │  │  │
...
1.【接口规范】该接口参考文档位置：
      接口产品规范：open.unionpay.com帮助中心 下载  产品接口规范  《订购产品接口规范》
